...
class GameRoom {
  ...
  XWordModel? creatorWord;
  XWordModel? JonerWord;
  String CreatorId;
  String? JoinerId;
  String CreatorName;
  String? JoinerName;
  ...
  factory GameRoom.fromMap(Map<String, dynamic> map) {
    return GameRoom(
      ...
      creatorWord: map['creatorWord'] != null ? XWordModel.fromMap(map['creatorWord'] as Map<String,dynamic>) : null,
      JonerWord: map['JonerWord'] != null ? XWordModel.fromMap(map['JonerWord'] as Map<String,dynamic>) : null,
